...
static const char *spotify[]  = { "spotify", "--no-zygote", NULL };
static const char *setkeyboard[]  = { "/home/cristi/dwm/set_keyboard.sh", NULL };
...
static const Key keys[] = {
	...
	//{ MODKEY|ShiftMask,             XK_k,      spawn,          SHCMD("pkill dwm") },
